...
1. Connect this local Git repository to GitHub.
2. Install or locate Isaac Sim and verify it can run on the RTX 4080.
3. Create a Cesium ion token and configure the Marine City geospatial scene.
4. Build the first Isaac scene with three UAV camera viewpoints.
5. Add the detection/fusion pipeline and export synchronized frames plus camera poses.
