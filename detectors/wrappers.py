...
class UltralyticsWrapper(DetectorWrapper):
    ...
    def __init__(self, model_name: str = "yolo11n.pt", predict_kwargs: dict[str, Any] | None = None) -> None:
    ...
    def predict(
        ...
        *,
        ...
        results = self.model(str(image_path), verbose=False, **self.predict_kwargs)
