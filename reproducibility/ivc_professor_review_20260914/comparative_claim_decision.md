...
The completed cache-controlled audit does **not** support presenting the fixed
...
| Oracle AABB | ByteTrack | CoM3D-ACE (geometry-first ranking) | 45.19 | 46.34 | 49.72 | 17,511 |
...
| Oracle AABB | OC-SORT | CoM3D-ACE (geometry-first ranking) | 45.92 | 53.64 | 45.25 | 4,441 |
...
| Oracle AABB | Deep OC-SORT | CoM3D-ACE (geometry-first ranking) | 82.60 | 84.54 | 83.67 | 1,377 |
...
| Official detector | ByteTrack | CoM3D-ACE (geometry-first ranking) | 35.40 | 43.75 | 39.97 | 8,935 |
...
| Official detector | OC-SORT | CoM3D-ACE (geometry-first ranking) | 36.53 | 49.24 | 38.09 | 3,204 |
...
| Official detector | Deep OC-SORT | CoM3D-ACE (geometry-first ranking) | 54.31 | 67.84 | 64.08 | 1,046 |

Geometry+ReID greedy and partial Hungarian exceed fixed CoM3D-ACE IDF1 in all
...
| Input | Tracker | Method | IDF1 | IDSW | Coverage | Conditional error |
| --- | --- | --- | ---: | ---: | ---: | ---: |
| Oracle AABB | ByteTrack | CoM3D-ACE (geometry-first ranking) | 49.72 | 17,511 | 36.6% | 44.6% |
...
| Oracle AABB | OC-SORT | CoM3D-ACE (geometry-first ranking) | 45.25 | 4,441 | 37.9% | 35.1% |
...
| Oracle AABB | Deep OC-SORT | CoM3D-ACE (geometry-first ranking) | 83.67 | 1,377 | 26.1% | 39.2% |
...
| Official detector | ByteTrack | CoM3D-ACE (geometry-first ranking) | 39.97 | 8,935 | 34.4% | 29.7% |
...
| Official detector | OC-SORT | CoM3D-ACE (geometry-first ranking) | 38.09 | 3,204 | 35.4% | 38.9% |
...
| Official detector | Deep OC-SORT | CoM3D-ACE (geometry-first ranking) | 64.08 | 1,046 | 21.7% | 32.3% |
...
Conditional error is false/(correct+false) among accepted links whose two
endpoint identities are auditable. The auditable share is 12.8--13.3% for
oracle ByteTrack, 100% for oracle OC-SORT and Deep OC-SORT, and 4.4--13.8% for
official-detector conditions; unknown links remain in coverage.

At the unchanged 0.30 gate, common-cost reciprocal selection improves IDF1 and has
both higher accepted-link coverage and lower conditional link error than fixed
...
common-cost variant as the pre-specified method.
...
provide a strong end-to-end selection basis for the fixed rule.
