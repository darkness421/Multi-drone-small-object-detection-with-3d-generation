...
Incomplete experiments are marked as pending or 640-eval only. YOLOv9c is included as the YOLOv9 large-anchor row; YOLOv9e is excluded from the paper-facing comparison because it is outside the target size regime.
