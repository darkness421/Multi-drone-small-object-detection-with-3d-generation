...
main-paper-ready items from supplementary items and explicit validation slots.
...
| MarineCity real-capture benchmark table | `paper/tables/marinecity_real_capture_benchmark_table.tex` | Ready with wording limit | Supplementary source table for 3-scenario, 9-frame real-Cesium RGB/depth/pose capture |
| MarineCity cross-view evidence graph table | `paper/tables/marinecity_crossview_evidence_graph_table.tex` | Ready with wording limit | Supplementary table for 23 real-Cesium EvidenceTokens grouped into 13 smoke-test hypotheses |
...
- The AeroGraph table is a supplementary validation slot until a complete
  external-provider manifest is selected by
  `scripts/build_aerograph_reasoner_table.py`.
