...
- MarineCity system-validation table: `tables/marinecity_system_scenario_table`
- MarineCity neural-3D validation metric table: `tables/marinecity_3d_completion_results_table`
...
- Fig. 3 neural-3D validation evidence:
...
The current MarineCity results should be described as real-Cesium
system/protocol validation evidence and runner-family neural-3D validation
evidence, not as a completed large-scale 3D reconstruction benchmark.
