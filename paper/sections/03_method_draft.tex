...
points are used for association and routing diagnostics, not as metric 3D
ground truth.
...
largest invalid/black-region ratio among supporting crops. The routing policy is
\begin{equation}
\pi(o)=
\begin{cases}
...
paper reports real-Cesium system/protocol validation, graph-routing diagnostics,
and neural-3D runner-family validation metrics while keeping final action decisions
gated by graph and safety verification.}
