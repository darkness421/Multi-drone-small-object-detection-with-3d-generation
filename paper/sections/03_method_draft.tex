...
otherwise the MarineCity smoke protocol uses a ground-plane intersection. These
...
and neural-3D runner-family smoke metrics while keeping final action decisions
