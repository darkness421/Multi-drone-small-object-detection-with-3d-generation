...
ASSETS = [
    ...
    Asset(
        "UAV 1 RGB view",
        Path("outputs/isaac_exports/marinecity_gpu1_replicator_direct_v5/replicator_direct/frame_001_uav_01_rgb.png"),
        "fig1_uav01_rgb.png",
        "Fig. 1",
    ...
    Asset(
        "UAV 2 RGB view",
        Path("outputs/isaac_exports/marinecity_gpu1_replicator_direct_v5/replicator_direct/frame_002_uav_02_rgb.png"),
        "fig1_uav02_rgb.png",
        "Fig. 1",
        "Raw UAV view for the multi-UAV observations column.",
    ),
    Asset(
        "UAV 3 RGB view",
        Path("outputs/isaac_exports/marinecity_gpu1_replicator_direct_v5/replicator_direct/frame_003_uav_03_rgb.png"),
        "fig1_uav03_rgb.png",
        "Fig. 1",
        "Raw UAV view for the multi-UAV observations column.",
    ),
    ...
    Asset(
        ...
        Path("outputs/evidence/marinecity_detector_smoke_20260623_conf001/previews/frame_001_uav_01_rgb_pred.png"),
    ...
    Asset(
        ...
        Path("outputs/evidence/marinecity_detector_smoke_20260623_conf001/previews/frame_002_uav_02_rgb_pred.png"),
    ...
    Asset(
        ...
        Path("outputs/evidence/marinecity_detector_smoke_20260623_conf001/previews/frame_003_uav_03_rgb_pred.png"),
    ...
    Asset(
        ...
        Path("outputs/evidence/marinecity_detector_smoke_20260623_conf001/evidence_tokens.jsonl"),
    ...
    Asset(
        ...
        Path("outputs/evidence/marinecity_detector_smoke_20260623_conf001/detector_smoke_summary.json"),
