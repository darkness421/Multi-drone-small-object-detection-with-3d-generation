...
ARTIFACTS = [
    ...
    Artifact("supp_system", "outputs/reports/live/marinecity_qualitative_selection_manifest.md", "runbook", True, "MarineCity qualitative selection rules"),
    Artifact("supp_system", "outputs/reports/live/marinecity_qualitative_gate.md", "runbook", True, "MarineCity full-frame vs crop-only qualitative gate"),
    ...
    Artifact("audit", "outputs/reports/live/paper_artifact_readiness_manifest.md", "audit", True, "Human-readable artifact manifest"),
...
TEXT_SCOPE = [
    ...
    "docs/paper_sections_index.md",
    "docs/paper_figures_index.md",
