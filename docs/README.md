...
- `agentic_automation_stack.md`: Ollama/local operator, OpenAI analyst, and coding agent editor role split.
...
- `system_ablation_evaluation_plan.md`: detector-only vs full-system ablation stack, category-wise metrics, and graph-grounded explainability evaluation.
...
- `isaac_3d_reasoner_readiness_2026-06-16.md`: one-to-two-day startup checklist for Isaac, MarineCity 3D, and AeroGraph Reasoner smoke tests.
- `llm_reasoner_adjudicator_plan.md`: final LLM/VLM adjudicator and re-observation policy plan.
- `aerograph_reasoner_naming.md`: paper-facing name and smoke-test status for the drone-specialized AeroGraph Reasoner.
- `aerograph_nonmock_collection_plan.md`: 49-prompt external-provider AeroGraph collection gate, import commands, and paper-promotion criteria.
