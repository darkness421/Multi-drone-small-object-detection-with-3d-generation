...
| Best proposed candidate | ProposedNext-P2TinyFReLU-yolo11l | Other | unknown | unknown | 1 | 0.38168 | 0.60305 |

## Gate Gaps

| Threshold | Baseline | Candidate | Primary Delta | Secondary Delta |
| --- | --- | --- | --- | --- |
| Best overall baseline | YOLOv11l | ProposedNext-P2TinyFReLU-yolo11l | +0.0040 | +0.0050 |
