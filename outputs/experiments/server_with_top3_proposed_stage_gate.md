...
| Best proposed candidate | ProposedTop3-SE-yolo12m | YOLO | v12 | medium | 1 | 0.36436 | 0.58038 |

## Gate Gaps

| Threshold | Baseline | Candidate | Primary Delta | Secondary Delta |
| --- | --- | --- | --- | --- |
| Best overall baseline | YOLOv12m | ProposedTop3-SE-yolo12m | -0.0025 | -0.0044 |
| Best lightweight baseline | YOLOv9s | ProposedTop3-SE-yolo12m | +0.0210 | +0.0259 |
