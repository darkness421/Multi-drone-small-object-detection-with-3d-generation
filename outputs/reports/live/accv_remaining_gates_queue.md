...
Updated: `2026-06-30T04:27:10+09:00`
...
| P3 | Optional AeroGraph external-provider benchmark | `aerograph_external_provider_responses_needed` | manual direct coverage=0/54; reviewed candidate=49/49; provider validation=False | Do not block the current submission. Collect OpenAI/ChatGPT/local-provider responses only if adding an external LLM benchmark claim. | optional_supp_or_future |
