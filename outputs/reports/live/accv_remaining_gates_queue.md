...
Updated: `2026-06-27T21:19:37+09:00`
...
| P1 | AeroGraph external non-mock reasoner | `aerograph_reviewed_candidate_ready_external_pending` | manual direct coverage=0/49; reviewed candidate=49/49; external replication=False | Keep the reviewed candidate internal; collect OpenAI/ChatGPT/local-provider replication before making a final external-provider reasoner claim. | pending_reasoner |
