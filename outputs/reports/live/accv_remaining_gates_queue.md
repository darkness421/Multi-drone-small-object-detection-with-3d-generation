...
Updated: `2026-06-27T17:29:56+09:00`
...
| P1 | MarineCity neural 3D completion metrics | `marinecity_3d_completion_ready` | captures ready=True; dataset ready=True; runner available=True; metric rows=2 | Use the verified Nerfacto and Splatfacto/3DGS-style rows as runner-family system-smoke evidence; add longer validation only if time remains. | main_smoke_or_supp |
