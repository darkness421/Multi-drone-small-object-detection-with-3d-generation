...
Updated: `2026-07-02 16:38:55 KST`
...
- Token-level system tests: `54`
- Artifact status: `marinecity_system_test_artifacts_complete`
- Real-capture detector/reasoner smoke: `marinecity_detector_reasoner_smoke_artifacts_ready`; tokens `78`; report `outputs/reports/live/marinecity_detector_reasoner_smoke.md`
...
- Integration check: `marinecity_system_integration_smoke_ready_with_open_final_gates`; actor classes `['bus', 'car', 'pedestrian', 'person', 'truck', 'van']`; detector classes `{'bus': 17, 'car': 53, 'pedestrian': 6, 'van': 2}`; report `outputs/reports/live/marinecity_system_integration_check.md`
...
- Full-frame ready: `True`; best full void `0.017833`; mean top-3 void `0.093141`
- Crop supplementary ready: `True`; best crop void `0.003579`; area `0.9025`
...
- Prompt pack: `aerograph_prompt_pack_ready`, prompts `54`
- Prompt class counts: `{'bus': 14, 'car': 32, 'pedestrian': 6, 'van': 2}`
...
- Web batches: `aerograph_web_batches_ready`, count `6`, dir `outputs/reports/live/aerograph_prompt_pack/web_batches`
- Dry-run status: `aerograph_eval_dry_run_ready`
- Paper table status: `aerograph_reasoner_table_complete`, selected manifest `outputs/reasoning/aerograph_prompt_pack_eval_manual/manifest.json`
- Reasoner readiness status: `aerograph_external_provider_pending_responses`
...
- Paper artifact manifest: `outputs/reports/live/paper_artifact_readiness_manifest.md`
- Paper artifact check: `outputs/reports/live/paper_artifact_readiness_check.json`; status `paper_artifact_audit_needs_attention`; missing `1`; stale claims `0`
...
- AeroGraph external-provider table slot: `paper/tables/aerograph_reasoner_external_slot.tex`
