...
- `paper_fig14_final_nms_robustness.png`
- `paper_fig15_final_input_resolution_sweep.png`
...
Archive-only diagnostics, not recommended for the default main or supplementary
paper:
