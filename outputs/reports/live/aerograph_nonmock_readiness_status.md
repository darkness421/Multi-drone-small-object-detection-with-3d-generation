...
- Status: `aerograph_reviewed_candidate_ready_external_pending`
...
- Response rows: `0`
- Matched nonblank responses: `0/49`
- Matched valid schema responses: `0/49`
- Coverage ratio: `0.0`
...
- A reviewed 49-prompt candidate table is available, but final OpenAI/ChatGPT/local-provider replication is still pending.
...
| 5 | 41-49 | 0/9 | pending | `outputs/reports/live/aerograph_prompt_pack/web_batches/aerograph_web_batch_05_041-049.md` |
